...
class SingleMessage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //start of send location bubble
    if (type == "link") {
      final parts = message!.replaceFirst("location:", "").split("%2C");
      ...
      return Container(
        ...
        child: Container(
          ...
          child: GestureDetector(
            ...
            child: Column(
              children: [
                Image.asset('assets/map_location-pic.jpg'),
                Divider(),
                Text(
                  "Shared Location - Tap to view",
                  style: TextStyle(
                    fontSize: 20,
