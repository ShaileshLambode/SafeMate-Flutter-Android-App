...
import 'package:safe_mate/chat_module/singleMessage.dart';
...
class _MessageTextFieldState extends State<MessageTextField> {
  ...
  String imageUrl = "";
  late SingleMessage chatProvider;

  //send location using geolocation
  /*    Future<void> _sendLocation() async {
    ...
    if (!serviceEnabled) {
      return; // Handle this appropriately in UI
    }
  ...
  Future uploadImage() async {
    // UploadTask uploadTask = chatProvider.uploadImage(imageFile!,
